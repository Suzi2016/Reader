...
public class ScreenUtils
{
    ...
    public static int getActionBarSize(Context context)
    {
        ...
        {
            int actionBarHeight = TypedValue.complexToDimensionPixelSize(tv.data, context
    ...
    public static boolean isAutoBrightness(Activity activity)
    {
        ...
        try
        {
            isAutoAdjustBright = Settings.System.getInt(activity.getContentResolver(), Settings
    ...
    public static float getScreenBrightness(Context mContext)
    {
        ...
        try
        {
            screenBrightness = Settings.System.getInt(mContext.getContentResolver(), Settings
